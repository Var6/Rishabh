      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 pt-24 pb-16 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
          ...
          >
            ...
            <div className="relative w-52 h-52 sm:w-64 sm:h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden border-2 border-indigo-300 dark:border-indigo-500/40 shadow-2xl">
              <Image
